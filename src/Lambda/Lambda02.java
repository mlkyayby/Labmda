...
public class Lambda02 {
    ...
    public static void tekKupBirFazlaPrint(List<Integer> sayi) {
        sayi.
                ...
                map(t -> (t * t * t) + 1);
    //tek elemanları küplerinin 1 fazlasına udate edildiforEach(Lambda01::yazdir);//print edildi
...
//Lambda Expression...
    ...
    public static void minBul(List<Integer> sayi) {
        ...
        int minSayiLJambda = (sayi.stream().reduce(Integer.MAX_VALUE, (x, y) -> x < y ? x : y));//aldigimiz ilk deger isleme etki etmememli
